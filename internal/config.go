...
type Config struct {
	...
	CookieName             string               `long:"cookie-name" env:"COOKIE_NAME" default:"_auth_token" description:"Cookie Name"`
	CSRFCookieName         string               `long:"csrf-cookie-name" env:"CSRF_COOKIE_NAME" default:"_auth_csrf" description:"CSRF Cookie Name"`
